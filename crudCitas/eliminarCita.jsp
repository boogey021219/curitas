...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div class="container mt-5">
        ...
        <%
            ...
            if (usuarioId != null && !usuarioId.isEmpty() && citaId != null && !citaId.isEmpty()) {
                ...
                try {
                    ...
                    String sqlVerificar = "SELECT * FROM citasmedicogeneral WHERE id = ? AND usuario_id = ?";
                    ...
                    if ("true".equals(request.getParameter("confirmar"))) {
                        String sqlEliminar = "DELETE FROM citasmedicogeneral WHERE id = ? AND usuario_id = ?";
        ...
        <form action="eliminarCita.jsp" method="POST">
            ...
            <div class="alert alert-warning mt-3">
                ¿Esta seguro de que desea eliminar la cita con ID <%= citaId %>?
                <br>
                <button type="submit" class="btn btn-danger mt-2" name="confirmar" value="true">Confirmar eliminacion</button>
                <a href="solicitudesCitas.jsp" class="btn btn-secondary mt-2">Cancelar</a>
            </div>
            <%
                } else {
            %>
