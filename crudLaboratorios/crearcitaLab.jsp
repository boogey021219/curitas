...
<%
    ...
    if (usuarioId != null && !usuarioId.isEmpty() &&
        ...
        try {
            ...
            String sql = "INSERT INTO citaslaboratorio (usuario_id, fecha, hora, tipo_prueba, estado) " +
                         "VALUES (?, ?, ?, ?, ?)";
            ...
            if (mensaje.isEmpty()) {
                ...
                if (filas > 0) {
                    ...
                    response.sendRedirect("solicitudesLaboratorios.jsp?cita=creada");  // Redirige a la página principal o a otra página
                } else {
