...
<%
    ...
    if (usuarioId != null && !usuarioId.isEmpty() &&
        ...
        tipoExamen != null && !tipoExamen.isEmpty() &&
        ...
        try {
            ...
            conexion = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/curitas",  // Cambia el nombre de la base de datos si es necesario
                "root",  // Cambia el usuario si es necesario
                "");     // Cambia la contraseña si es necesario

            // Preparar la sentencia SQL
            String sql = "INSERT INTO citaslaboratorio (usuario_id, fecha, hora, tipo_examen, descripcion, estado) " +
                         "VALUES (?, ?, ?, ?, ?, ?)";
            ...
            if (mensaje.isEmpty()) {
                ...
                if (filas > 0) {
                    mensaje = "La cita de laboratorio fue creada satisfactoriamente.";
                    response.sendRedirect("solicitudesCitasLaboratorio.jsp?cita=creada");  // Redirige a la página principal o a otra página
                } else {
                    mensaje = "No se pudo crear la cita de laboratorio.";
                }
            }
