...
<head>
    ...
    <meta name="Description" content="Buscar Usuario"/>
...
<div class="container mt-4">
    <h2 class="mb-4">Buscar Usuario por ID</h2>

    <!-- Formulario para buscar usuarios -->
    <form method="get" action="bdUserList.jsp" class="mb-4">
        <div class="form-group">
            <label for="id">Buscar por ID de Usuario:</label>
            <input type="text" class="form-control" id="id" name="usuarioId" placeholder="Ingresa ID de usuario" required>
        </div>
    ...
    <table class="table table-striped mt-4">
        ...
        <tbody>
            ...
            try {
                ...
                // Preparar la consulta SQL para buscar el usuario por ID
            ...
            %>
                    <tr>
                        ...
                        <td><%= rs.getString("tipo_afiliacion") %></td>
            ...
            %>
                    <tr>
                        <td colspan="10" class="text-center">No se encontró el usuario con ID <%= usuarioId %>.</td>
                    </tr>
            <%
                }
            } catch (Exception e) {
                e.printStackTrace();
                out.println("<tr><td colspan='10' class='text-center'>Error: " + e.getMessage() + "</td></tr>");
            } finally {
