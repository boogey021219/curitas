...
<head>
  ...
  <meta name="Description" content="Formulario para actualizar una cita médica"/>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.6.0/css/bootstrap.min.css">
<link rel="stylesheet" href="../css/lodeadentro.css">
  <title>Actualizar Cita Medico</title>
</head>
<body>
...
<!-- Sección "Icon Boxes" con SVG (sin cambios) -->

<!-- Contenido principal -->
<div class="container mt-4">
  <h2>Actualizar Cita Medica</h2>
